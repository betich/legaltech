        ...
        <div className="flex gap-6">
          ...
          <div className="ml-80 flex-1 space-y-6 pb-6">
            ...
            <div className={viewMode === 'grid' ? 'grid grid-cols-3 gap-4' : 'space-y-4'}>
              {[
                { id: 1, name: 'บันทึกคำให้การ.pdf', icon: File, uploader: 'ทนาย วิชัย' },
                { id: 2, name: 'ภาพถ่ายสถานที่.jpg', icon: Image, uploader: 'คุณวิภา' },
                { id: 3, name: 'วิดีโอบันทึก.mp4', icon: Play, uploader: 'คุณนภา' },
                { id: 4, name: 'สัญญาซื้อขาย.docx', icon: FileText, uploader: 'ทนาย ปิยะ' },
                { id: 5, name: 'หลักฐาน_02.jpg', icon: Image, uploader: 'คุณสมศักดิ์' },
                { id: 6, name: 'รายงานผู้เชี่ยวชาญ.pdf', icon: File, uploader: 'ดร.สมชาย' }
              ].map((item) => (
                  ...
                  {viewMode === 'grid' ? (
                    <div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="text-sm text-gray-500">15 ม.ค. 2567</div>
                      </div>
                    </div>
                  ) : (
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="font-medium">{item.name}</div>
                          <div className="text-sm text-gray-500">อัพโหลดโดย: {item.uploader} • 15 ม.ค. 2567</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
