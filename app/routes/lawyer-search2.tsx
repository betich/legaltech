      ...
      <header className="bg-white shadow-sm fixed w-full z-10">
        <div className="flex items-center justify-between px-6 py-3">
          <div className="flex items-center space-x-4">
            ...
            <div className="text-xl font-bold text-purple-600 ml-4">คดีหมายเลข 2024002</div>
          </div>
          <div className="flex items-center space-x-4">
            <div className="text-sm text-gray-600">อัพเดทล่าสุด: 2 ชั่วโมงที่แล้ว</div>
          </div>
        </div>
      </header>
      ...
      <div className="pt-16 px-6">
        <div className="flex gap-6">
          <div className="w-72 fixed left-6 mt-6 space-y-4">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">ศาลอาญากรุงเทพใต้</div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>นัดพิจารณา: 25 ก.พ. 2567</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm font-medium">หมวดหมู่หลักฐาน</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="ml-80 flex-1 space-y-6 pb-6">
            ...
            <div className={viewMode === 'grid' ? 'grid grid-cols-3 gap-4' : 'space-y-4'}>
              {[
                { id: 1, name: 'บันทึกการสอบสวน.pdf', icon: File, uploader: 'พนักงานสอบสวน' },
                { id: 2, name: 'ภาพถ่ายที่เกิดเหตุ.jpg', icon: Image, uploader: 'เจ้าหน้าที่ตำรวจ' },
                { id: 3, name: 'วิดีโอกล้องวงจรปิด.mp4', icon: Play, uploader: 'เจ้าหน้าที่สืบสวน' },
                { id: 4, name: 'รายงานการตรวจสอบ.pdf', icon: FileText, uploader: 'ผู้เชี่ยวชาญ' },
                { id: 5, name: 'ภาพถ่ายหลักฐาน.jpg', icon: Image, uploader: 'เจ้าหน้าที่พิสูจน์หลักฐาน' },
                { id: 6, name: 'บันทึกคำให้การพยาน.pdf', icon: File, uploader: 'พนักงานอัยการ' }
              ].map((item) => (
                  ...
                  {viewMode === 'grid' ? (
                    <div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="mt-2 text-sm text-gray-500">อัพโหลดโดย: {item.uploader}</div>
                        <div className="text-sm text-gray-500">18 ม.ค. 2567</div>
                      </div>
                    </div>
                  ) : (
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="font-medium">{item.name}</div>
                          <div className="text-sm text-gray-500">อัพโหลดโดย: {item.uploader} • 18 ม.ค. 2567</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
