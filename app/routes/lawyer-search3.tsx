      ...
      <header className="bg-white shadow-sm fixed w-full z-10">
        <div className="flex items-center justify-between px-6 py-3">
          <div className="flex items-center space-x-4">
            ...
            <div className="text-xl font-bold text-purple-600 ml-4">คดีหมายเลข 2024003</div>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <div className="flex gap-6">
          ...
          <div className="ml-80 flex-1 space-y-6 pb-6">
            ...
            <div className={viewMode === 'grid' ? 'grid grid-cols-3 gap-4' : 'space-y-4'}>
              {[
                { id: 1, name: 'บันทึกการสอบปากคำ.pdf', icon: File, uploader: 'พนักงานสอบสวน สมชาย' },
                { id: 2, name: 'ภาพถ่ายที่เกิดเหตุ.jpg', icon: Image, uploader: 'จ่าสิบเอก มานะ' },
                { id: 3, name: 'วิดีโอกล้องวงจรปิด.mp4', icon: Play, uploader: 'ร.ต.ท. วิชัย' },
                { id: 4, name: 'รายงานการตรวจสถานที่.docx', icon: FileText, uploader: 'พ.ต.ท. ประสิทธิ์' },
                { id: 5, name: 'ภาพถ่ายวัตถุพยาน.jpg', icon: Image, uploader: 'จ่าสิบตำรวจ สมศักดิ์' },
                { id: 6, name: 'รายงานนิติเวช.pdf', icon: File, uploader: 'นพ.รุ่งโรจน์' }
              ].map((item) => (
                  ...
                  {viewMode === 'grid' ? (
                    <div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="text-sm text-gray-500">28 ก.พ. 2567</div>
                      </div>
                    </div>
                  ) : (
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="font-medium">{item.name}</div>
                          <div className="text-sm text-gray-500">อัพโหลดโดย: {item.uploader} • 28 ก.พ. 2567</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
