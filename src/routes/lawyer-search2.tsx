          ...
          <div className="ml-80 flex-1 space-y-6 pb-6">
            ...
            >
              {[
                {
                  id: 1,
                  name: "บันทึกการสอบสวน.pdf",
                  icon: File,
                  uploader: "พนักงานสอบสวน",
                },
                {
                  id: 2,
                  name: "ภาพถ่ายที่เกิดเหตุ.jpg",
                  icon: Image,
                  uploader: "เจ้าหน้าที่ตำรวจ",
                },
                {
                  id: 3,
                  name: "วิดีโอกล้องวงจรปิด.mp4",
                  icon: Play,
                  uploader: "เจ้าหน้าที่สืบสวน",
                },
                {
                  id: 4,
                  name: "รายงานการตรวจสอบ.pdf",
                  icon: FileText,
                  uploader: "ผู้เชี่ยวชาญ",
                },
                {
                  id: 5,
                  name: "ภาพถ่ายหลักฐาน.jpg",
                  icon: Image,
                  uploader: "เจ้าหน้าที่พิสูจน์หลักฐาน",
                },
                {
                  id: 6,
                  name: "บันทึกคำให้การพยาน.pdf",
                  icon: File,
                  uploader: "พนักงานอัยการ",
                },
              ].map((item) => (
                <Card
                  key={item.id}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="font-medium">{item.name}</div>
                          <div className="text-sm text-gray-500">
                            อัพโหลดโดย: {item.uploader} • 18 ม.ค. 2567
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
